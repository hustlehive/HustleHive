...
const GuidelinesTab = () => (
  <div className="space-y-4">
    <Highlight variant="info">
      HustleHive is a verified college platform. Every user is a real student. Treat everyone with the same respect you would expect in person.
    </Highlight>
    ...
    <Section icon={Users} title="Friend & Connection Rules">
      <ul className="list-disc list-inside space-y-1.5">
        ...
        <li>Do not impersonate other students.</li>
      </ul>
    </Section>

    <Section icon={Eye} title="Content & Images">
      <ul className="list-disc list-inside space-y-1.5">
        <li>Profile pictures must be appropriate.</li>
        ...
        <li>Any content that promotes hatred, discrimination, or violence will be removed immediately and the user will be banned from using HustleHive in future.</li>
      </ul>
      <Highlight variant="danger">
  ...
  <div className="space-y-4">
    ...
    <Section icon={Shield} title="What Data We Collect" defaultOpen>
      ...
      <ul className="list-disc list-inside space-y-1.5 mt-2">
        ...
        <li><strong className="text-foreground">Message Metadata:</strong> Conversation participants, timestamps, and read receipts.</li>
