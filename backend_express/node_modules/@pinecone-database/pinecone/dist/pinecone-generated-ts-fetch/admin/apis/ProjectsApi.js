...
class ProjectsApi extends runtime.BaseAPI {
     ...
     * Get project details
     */
    async fetchProjectRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
     ...
     * Get project details
     */
    async fetchProject(requestParameters, initOverrides) {
     ...
     * List projects
     */
    async listProjectsRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ProjectListFromJSON)(jsonValue));
    }
    /**
     * List all projects in an organization.
     * List projects
     */
    async listProjects(requestParameters, initOverrides) {
