...
class UsersApi extends runtime.BaseAPI {
     ...
     * Get user details
     */
    async fetchUserRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
     ...
     * Get user details
     */
    async fetchUser(requestParameters, initOverrides) {
     ...
     */
    async listUsersRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.UserListFromJSON)(jsonValue));
    }
    /**
     * List users in the caller\'s organization, optionally filtered by email address.
     * List users in the organization
     */
    async listUsers(requestParameters, initOverrides) {
