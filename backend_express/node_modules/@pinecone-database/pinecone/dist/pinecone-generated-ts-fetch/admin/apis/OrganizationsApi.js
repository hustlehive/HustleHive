...
class OrganizationsApi extends runtime.BaseAPI {
     ...
     */
    async fetchOrganizationRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
     ...
     * Get organization details
     */
    async fetchOrganization(requestParameters, initOverrides) {
     ...
     * List organizations
     */
    async listOrganizationsRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.OrganizationListFromJSON)(jsonValue));
    }
    /**
     * List all organizations associated with an account.
     * List organizations
     */
    async listOrganizations(requestParameters, initOverrides) {
    ...
    async updateOrganizationRaw(requestParameters, initOverrides) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: (0, index_1.UpdateOrganizationRequestToJSON)(requestParameters.updateOrganizationRequest),
        }, initOverrides);
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.OrganizationFromJSON)(jsonValue));
    }
    /**
