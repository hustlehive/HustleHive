...
class APIKeysApi extends runtime.BaseAPI {
    ...
    async createApiKeyRaw(requestParameters, initOverrides) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.APIKeyWithSecretFromJSON)(jsonValue));
    }
    /**
     * Create an API key for a project to authenticate Data Plane and Control Plane requests.
     * Create an API key
     ...
     * Get API key details
     */
    async fetchApiKeyRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
     ...
     * Get API key details
     */
    async fetchApiKey(requestParameters, initOverrides) {
     ...
     * List API keys
     */
    async listProjectApiKeysRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ListApiKeysResponseFromJSON)(jsonValue));
    }
    /**
     * List all API keys in a project.
     * List API keys
     */
    async listProjectApiKeys(requestParameters, initOverrides) {
