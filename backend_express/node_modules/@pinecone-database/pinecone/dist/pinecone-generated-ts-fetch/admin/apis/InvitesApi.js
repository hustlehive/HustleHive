...
class InvitesApi extends runtime.BaseAPI {
     ...
     * Get invite details
     */
    async fetchInviteRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
     ...
     * Get invite details
     */
    async fetchInvite(requestParameters, initOverrides) {
     ...
     * List invites
     */
    async listInvitesRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.InviteListFromJSON)(jsonValue));
    }
    /**
     * List pending and expired invites in the caller\'s organization.
     * List invites
     */
    async listInvites(requestParameters, initOverrides) {
     ...
     */
    async resendInviteRaw(requestParameters, initOverrides) {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
     ...
     * Resend an invite email
     */
    async resendInvite(requestParameters, initOverrides) {
