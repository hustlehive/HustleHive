 ...
 */
export declare function instanceOfRoleBinding(value: object): boolean;
export declare function RoleBindingFromJSON(json: any): RoleBinding;
export declare function RoleBindingFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoleBinding;
export declare function RoleBindingToJSON(value?: RoleBinding | null): any;
