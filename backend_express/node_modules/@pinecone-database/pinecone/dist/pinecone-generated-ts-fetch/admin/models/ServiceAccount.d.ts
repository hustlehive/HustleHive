 ...
 */
export declare function instanceOfServiceAccount(value: object): boolean;
export declare function ServiceAccountFromJSON(json: any): ServiceAccount;
export declare function ServiceAccountFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceAccount;
export declare function ServiceAccountToJSON(value?: ServiceAccount | null): any;
