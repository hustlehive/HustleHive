 ...
 */
export declare function instanceOfUpdateAssistantResponse(value: object): boolean;
export declare function UpdateAssistantResponseFromJSON(json: any): UpdateAssistantResponse;
export declare function UpdateAssistantResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateAssistantResponse;
export declare function UpdateAssistantResponseToJSON(value?: UpdateAssistantResponse | null): any;
