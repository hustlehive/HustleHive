...
export interface CreateIndexSchema {
     ...
     */
    fields: {
        [key: string]: CreateIndexSchemaField;
    };
}
/**
 * Check if a given object implements the CreateIndexSchema interface.
 */
export declare function instanceOfCreateIndexSchema(value: object): boolean;
export declare function CreateIndexSchemaFromJSON(json: any): CreateIndexSchema;
export declare function CreateIndexSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateIndexSchema;
export declare function CreateIndexSchemaToJSON(value?: CreateIndexSchema | null): any;
