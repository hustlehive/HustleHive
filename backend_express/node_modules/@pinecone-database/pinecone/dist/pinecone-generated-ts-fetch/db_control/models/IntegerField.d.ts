 ...
 * @export
 */
export declare const IntegerFieldTypeEnum: {
 ...
 */
export declare function instanceOfIntegerField(value: object): boolean;
export declare function IntegerFieldFromJSON(json: any): IntegerField;
export declare function IntegerFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): IntegerField;
export declare function IntegerFieldToJSON(value?: IntegerField | null): any;
