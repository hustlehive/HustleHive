 ...
 */
export declare function instanceOfReadCapacityStatus(value: object): boolean;
export declare function ReadCapacityStatusFromJSON(json: any): ReadCapacityStatus;
export declare function ReadCapacityStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadCapacityStatus;
export declare function ReadCapacityStatusToJSON(value?: ReadCapacityStatus | null): any;
