 ...
 * @export
 */
export declare const ResponseStringFieldTypeEnum: {
 ...
 */
export declare function instanceOfResponseStringField(value: object): boolean;
export declare function ResponseStringFieldFromJSON(json: any): ResponseStringField;
export declare function ResponseStringFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponseStringField;
export declare function ResponseStringFieldToJSON(value?: ResponseStringField | null): any;
