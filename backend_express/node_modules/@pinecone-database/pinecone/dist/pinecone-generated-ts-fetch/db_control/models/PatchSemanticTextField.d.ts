 ...
 * @export
 */
export declare const PatchSemanticTextFieldTypeEnum: {
    readonly SemanticText: "semantic_text";
};
 ...
 */
export declare function instanceOfPatchSemanticTextField(value: object): boolean;
export declare function PatchSemanticTextFieldFromJSON(json: any): PatchSemanticTextField;
export declare function PatchSemanticTextFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchSemanticTextField;
export declare function PatchSemanticTextFieldToJSON(value?: PatchSemanticTextField | null): any;
