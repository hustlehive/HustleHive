 ...
 * @export
 */
export declare const FloatFieldTypeEnum: {
 ...
 */
export declare function instanceOfFloatField(value: object): boolean;
export declare function FloatFieldFromJSON(json: any): FloatField;
export declare function FloatFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): FloatField;
export declare function FloatFieldToJSON(value?: FloatField | null): any;
