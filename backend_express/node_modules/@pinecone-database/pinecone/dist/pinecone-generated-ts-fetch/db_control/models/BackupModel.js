...
function BackupModelFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'sourceIndexDeletedAt': !(0, runtime_1.exists)(json, 'source_index_deleted_at') ? undefined : (new Date(json['source_index_deleted_at'])),
        'name': !(0, runtime_1.exists)(json, 'name') ? undefined : json['name'],
        'description': !(0, runtime_1.exists)(json, 'description') ? undefined : json['description'],
        'status': json['status'],
        'cloud': json['cloud'],
        'region': json['region'],
        'schema': !(0, runtime_1.exists)(json, 'schema') ? undefined : (0, IndexSchema_1.IndexSchemaFromJSON)(json['schema']),
