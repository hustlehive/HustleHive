 ...
 * @export
 */
export declare const ManagedDeploymentDeploymentTypeEnum: {
 ...
 */
export declare function instanceOfManagedDeployment(value: object): boolean;
export declare function ManagedDeploymentFromJSON(json: any): ManagedDeployment;
export declare function ManagedDeploymentFromJSONTyped(json: any, ignoreDiscriminator: boolean): ManagedDeployment;
export declare function ManagedDeploymentToJSON(value?: ManagedDeployment | null): any;
