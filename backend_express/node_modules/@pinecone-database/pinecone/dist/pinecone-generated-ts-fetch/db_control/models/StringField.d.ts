 ...
 */
export declare function instanceOfStringField(value: object): boolean;
export declare function StringFieldFromJSON(json: any): StringField;
export declare function StringFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): StringField;
export declare function StringFieldToJSON(value?: StringField | null): any;
