 ...
 */
export declare function instanceOfScalingConfigManual(value: object): boolean;
export declare function ScalingConfigManualFromJSON(json: any): ScalingConfigManual;
export declare function ScalingConfigManualFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScalingConfigManual;
export declare function ScalingConfigManualToJSON(value?: ScalingConfigManual | null): any;
