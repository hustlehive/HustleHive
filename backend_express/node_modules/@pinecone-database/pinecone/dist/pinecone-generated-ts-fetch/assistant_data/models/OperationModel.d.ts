 ...
 */
export declare function instanceOfOperationModel(value: object): boolean;
export declare function OperationModelFromJSON(json: any): OperationModel;
export declare function OperationModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): OperationModel;
export declare function OperationModelToJSON(value?: OperationModel | null): any;
