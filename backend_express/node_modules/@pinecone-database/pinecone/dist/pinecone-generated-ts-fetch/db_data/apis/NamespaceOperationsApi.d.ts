...
import type { CreateNamespaceRequest, ListNamespacesResponse, NamespaceDescription } from '../models/index';
...
export declare class NamespaceOperationsApi extends runtime.BaseAPI {
     ...
     * Create a namespace
     */
    createNamespaceRaw(requestParameters: CreateNamespaceOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NamespaceDescription>>;
    /**
     * Create a namespace in a serverless index.  For guidance and examples, see [Manage namespaces](https://docs.pinecone.io/guides/manage-data/manage-namespaces).  **Note:** This operation is not supported for pod-based indexes.
     * Create a namespace
     */
    createNamespace(requestParameters: CreateNamespaceOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<NamespaceDescription>;
    /**
