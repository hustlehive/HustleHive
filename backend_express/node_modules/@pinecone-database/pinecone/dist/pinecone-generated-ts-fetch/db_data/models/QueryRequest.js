...
function QueryRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'scanFactor': !(0, runtime_1.exists)(json, 'scanFactor') ? undefined : json['scanFactor'],
        'maxCandidates': !(0, runtime_1.exists)(json, 'maxCandidates') ? undefined : json['maxCandidates'],
    };
}
