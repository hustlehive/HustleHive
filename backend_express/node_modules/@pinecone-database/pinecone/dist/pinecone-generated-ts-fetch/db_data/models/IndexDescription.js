...
function IndexDescriptionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'memoryFullness': !(0, runtime_1.exists)(json, 'memoryFullness') ? undefined : json['memoryFullness'],
        'storageFullness': !(0, runtime_1.exists)(json, 'storageFullness') ? undefined : json['storageFullness'],
    };
}
