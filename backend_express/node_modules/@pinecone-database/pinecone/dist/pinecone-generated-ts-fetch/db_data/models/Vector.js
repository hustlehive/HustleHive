...
function VectorFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'metadata': !(0, runtime_1.exists)(json, 'metadata') ? undefined : ((0, runtime_1.mapValues)(json['metadata'], MetadataValue_1.MetadataValueFromJSON)),
    };
}
function VectorToJSON(value) {
    ...
    return {
        ...
        'metadata': value.metadata === undefined ? undefined : ((0, runtime_1.mapValues)(value.metadata, MetadataValue_1.MetadataValueToJSON)),
    };
}
