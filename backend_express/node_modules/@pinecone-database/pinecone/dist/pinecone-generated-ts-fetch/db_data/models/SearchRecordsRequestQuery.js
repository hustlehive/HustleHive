...
const SearchMatchTerms_1 = require("./SearchMatchTerms");
...
function SearchRecordsRequestQueryFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'matchTerms': !(0, runtime_1.exists)(json, 'match_terms') ? undefined : (0, SearchMatchTerms_1.SearchMatchTermsFromJSON)(json['match_terms']),
    };
}
