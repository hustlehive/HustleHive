...
const indexOperationsBuilder_1 = require("../control/indexOperationsBuilder");
const describeIndex_1 = require("../control/indexes/describeIndex");
...
exports.IndexHostSingleton = (function () {
    ...
    const _describeIndex = async (config, indexName) => {
        const indexOperationsApi = (0, indexOperationsBuilder_1.indexOperationsBuilder)(config);
        const describeResponse = await (0, describeIndex_1.describeIndex)(indexOperationsApi, indexName);
