...
import { Pagination } from '../../pinecone-generated-ts-fetch/db_data';
...
export declare class FetchByMetadataCommand<T extends RecordMetadata = RecordMetadata> {
    apiProvider: VectorOperationsProvider;
    namespace: string;
    constructor(apiProvider: any, namespace: any);
    validator: (options: FetchByMetadataOptions) => void;
    run(options: FetchByMetadataOptions): Promise<FetchByMetadataResponse<T>>;
}
