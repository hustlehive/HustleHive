...
exports.DocumentOperationsProvider = void 0;
...
class DocumentOperationsProvider {
    config;
    indexName;
    indexHostUrl;
    additionalHeaders;
    ...
    _buildApi() {
        const headers = (0, additionalHeaders_1.withoutContentType)(this.additionalHeaders);
        const apiConfig = {
...
exports.DocumentOperationsProvider = DocumentOperationsProvider;
//# sourceMappingURL=documentOperationsProvider.js.map