import type { RestoreJobList, RestoreJobModel } from '../../pinecone-generated-ts-fetch/db_control';
import type { PineconeConfiguration } from '../../data';
import { ListRestoreJobsOptions } from './listRestoreJobs';
/**
 ...
 * ```
 */
export declare class RestoreJobs {
    private _api;
     ...
     * ```
     */
    list(options?: ListRestoreJobsOptions): Promise<RestoreJobList>;
    /**
     ...
     */
    describe(jobId: string): Promise<RestoreJobModel>;
}
