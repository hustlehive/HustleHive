...
export type ReadCapacityOnDemandParams = Extract<CreateIndexReadCapacity, {
    /** Selects the legacy on-demand variant. */
    mode?: 'OnDemand';
}>;
/** @deprecated Use {@link ReadCapacityDedicated} with nested read capacity. */
export type ReadCapacityDedicatedParams = Extract<CreateIndexReadCapacity, {
...
export interface LegacyCreateIndexOptions extends Omit<NativeCreateIndexOptions, 'schema' | 'deployment' | 'dimension' | 'metric' | 'vectorType' | 'spec' | 'readCapacity'> {
