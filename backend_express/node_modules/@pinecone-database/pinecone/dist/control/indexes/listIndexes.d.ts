...
import type { ManageIndexesApi, IndexList as GeneratedIndexList, IndexModel as GeneratedIndexModel, IndexModelStatus as GeneratedIndexModelStatus, IndexSchema as GeneratedIndexSchema, ReadCapacityStatus as GeneratedReadCapacityStatus, ReadCapacityDedicatedSpecResponse as GeneratedReadCapacityDedicatedSpecResponse, ReadCapacityOnDemandSpecResponse as GeneratedReadCapacityOnDemandSpecResponse, BooleanField, DenseVectorField, FloatField, IntegerField, LegacyMetadataField, ResponseStringField, SemanticTextField, SparseVectorField, StringListField } from '../../pinecone-generated-ts-fetch/db_control';
import type { DeletionProtection, IndexMetric, IndexState, ReadCapacityState } from '../types';
export type { LegacyMetadataField, IntegerField, ResponseStringField, ResponseStringFieldFullTextSearch, ResponseStringFieldFullTextSearchNgram, ReadCapacityDedicatedConfig, ScalingConfigManual, } from '../../pinecone-generated-ts-fetch/db_control';
/**
 * The status of an index.
 */
export interface IndexModelStatus extends Omit<GeneratedIndexModelStatus, 'state'> {
 ...
 * shard counts.
 */
export interface ReadCapacityStatus extends Omit<GeneratedReadCapacityStatus, 'state'> {
 ...
 */
export interface ReadCapacityDedicatedSpecResponse extends Omit<GeneratedReadCapacityDedicatedSpecResponse, 'status'> {
    /** The current state of the read capacity configuration. */
 ...
 */
export interface ReadCapacityOnDemandSpecResponse extends Omit<GeneratedReadCapacityOnDemandSpecResponse, 'status'> {
    /** The current state of the read capacity configuration. */
    status: ReadCapacityStatus;
}
/**
...
export interface IndexSchema extends Omit<GeneratedIndexSchema, 'fields'> {
    ...
    fields: {
        [fieldName: string]: IndexSchemaField;
    };
}
/**
 ...
 */
export interface IndexModelData extends Omit<GeneratedIndexModel, 'status' | 'schema' | 'readCapacity' | 'deletionProtection'> {
 ...
 *
 */
export declare function listIndexes(api: ManageIndexesApi): Promise<IndexList>;
