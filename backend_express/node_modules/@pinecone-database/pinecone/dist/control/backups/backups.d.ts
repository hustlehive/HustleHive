...
import { CreateBackupResourceOptions } from './createBackup';
import { ListIndexBackupsOptions } from './listIndexBackups';
import { ListProjectBackupsOptions } from './listProjectBackups';
import { CreateIndexFromBackupResourceOptions } from './createIndexFromBackup';
/**
...
export declare class Backups {
     ...
     * ```
     */
    create(indexName: string, options?: CreateBackupResourceOptions): Promise<BackupModel>;
    /**
     ...
     */
    listByIndex(indexName: string, options?: ListIndexBackupsOptions): Promise<BackupList>;
    /**
     ...
     */
    list(options?: ListProjectBackupsOptions): Promise<BackupList>;
    /**
     ...
     * ```
     */
    describe(backupId: string): Promise<BackupModel>;
    /**
     * Deletes a backup.
     *
     ...
     */
    createIndex(backupId: string, options: CreateIndexFromBackupResourceOptions): Promise<CreateIndexFromBackupResponse>;
}
