 ...
 */
async function createCollection(api, options) {
    if (!options.name) {
    ...
    try {
        ...
        throw await (0, handling_1.handleApiError)(e, async (_, rawMessageText) => `Error creating collection ${options.name}: ${rawMessageText}`);
    }
}
