 ...
 */
export type IndexState = 'Initializing' | 'InitializationFailed' | 'Failed' | 'ScalingUp' | 'ScalingDown' | 'ScalingUpPodSize' | 'Terminating' | 'Ready' | 'Disabled' | (string & {});
/**
 * The current status of a collection.
 *
 * @see [Understanding collections](https://docs.pinecone.io/docs/collections)
 */
export type CollectionStatus = 'Initializing' | 'Ready' | 'Terminating' | (string & {});
/**
 * The current status of a backup.
 *
 * @see [Backups](https://docs.pinecone.io/guides/indexes/backups)
 */
export type BackupStatus = 'Initializing' | 'Ready' | 'InitializationFailed' | (string & {});
/**
 ...
 */
export type ReadCapacityState = 'Ready' | 'Scaling' | 'Migrating' | 'Error' | (string & {});
/**
 * @see [Understanding indexes](https://docs.pinecone.io/docs/indexes)
 */
export type PodType = 's1.x1' | 's1.x2' | 's1.x4' | 's1.x8' | 'p1.x1' | 'p1.x2' | 'p1.x4' | 'p1.x8' | 'p2.x1' | 'p2.x2' | 'p2.x4' | 'p2.x8';
