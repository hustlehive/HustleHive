...
const chatCompletionStream = (assistantName, apiProvider, config) => {
    return async (options) => {
        ...
        const chatUrl = `${hostUrl}/chat/${encodeURIComponent(assistantName)}/chat/completions`;
        (0, requestPath_1.assertRequestPathIsAddressable)(chatUrl);
