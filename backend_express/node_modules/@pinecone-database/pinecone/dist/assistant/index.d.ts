...
import type { ChatCompletionOptions, ChatOptions, ContextOptions, ListFilesOptions, ListOperationsOptions, UploadFileOptions, UpsertFileOptions } from './data/types';
...
export type { ChatOptions, ChatContextOptions, ChatCompletionOptions, ContextOptions, ListFilesOptions, ListOperationsOptions, UploadFileOptions, UpsertFileOptions, Uploadable, AssistantFilesList, MessagesModel, MessageModel, ChatModelEnum, StreamedChatResponse, StreamedChatCompletionResponse, BaseChunk, MessageStartChunk, ContentChunk, CitationChunk, MessageEndChunk, ChoiceModel, FinishReasonEnum, } from './data/types';
export type { AssistantFileModel, ChatModel, ChatCompletionModel, ContextModel, UsageModel, CitationModel, SnippetModel, TextSnippetModel, MultiModalSnippetModel, ReferenceModel, HighlightModel, OperationModel, OperationList, PaginationResponse, } from '../pinecone-generated-ts-fetch/assistant_data';
...
export declare class Assistant {
     ...
     */
    uploadFile(options: UploadFileOptions): Promise<import("../pinecone-generated-ts-fetch/assistant_data").OperationModel>;
    /**
     ...
     */
    upsertFile(options: UpsertFileOptions): Promise<import("../pinecone-generated-ts-fetch/assistant_data").OperationModel>;
    /**
     ...
     * ```
     */
    deleteFile(fileId: string): Promise<import("../pinecone-generated-ts-fetch/assistant_data").OperationModel>;
    /**
     ...
     */
    describeOperation(operationId: string): Promise<import("../pinecone-generated-ts-fetch/assistant_data").OperationModel>;
    /**
     ...
     */
    listOperations(options?: ListOperationsOptions): Promise<import("../pinecone-generated-ts-fetch/assistant_data").OperationList>;
    /**
