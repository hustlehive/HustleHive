 ...
 */
export declare const mergeAdditionalHeaders: (clientHeaders?: HTTPHeaders, targetHeaders?: HTTPHeaders) => HTTPHeaders | undefined;
/** Removes caller content types so each operation retains its body encoding. */
export declare const withoutContentType: (headers?: HTTPHeaders) => HTTPHeaders;
