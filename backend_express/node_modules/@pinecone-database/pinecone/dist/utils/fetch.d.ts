 ...
 */
export declare const getFetch: (config: Pick<PineconeConfiguration, "fetchApi" | "maxRetries">) => (input: (Request | string) | URL, init?: RequestInit) => Promise<Response>;
/**
 ...
 * first read.
 */
export declare const getNonRetryingFetch: (config: Pick<PineconeConfiguration, "fetchApi">) => (input: (Request | string) | URL, init?: RequestInit) => Promise<Response>;
